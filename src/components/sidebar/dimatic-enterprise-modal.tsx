...
import { DimaticLogo } from './dimatic-logo';
...
export function DimaticEnterpriseModal({
  children,
  open: controlledOpen,
...
export const DimaticProcessModal = DimaticEnterpriseModal;
