        ...
        <div className="mb-6">
          <CodeBlock
            data={[{
              language: "bash",
              filename: "terminal",
              code: `git clone https://github.com/dimatic-ai/dimatic.git
cd dimatic`
            }]}
            defaultValue="bash"
          >
...
docker compose down`
      ...
      <DocsBody className="mb-8">
        ...
        <p className="mb-4">You should see the Dimatic dashboard where you can start chatting with Dimatic or create your own agents.</p>
