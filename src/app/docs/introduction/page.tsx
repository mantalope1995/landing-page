  ...
  return (
    <>
      <DocsHeader
        ...
        subtitle="A private platform for building AI agents that actually get things done"
      ...
      <DocsImage
        src={imageSrc}
        alt="Dimatic Platform Interface"
        size="full"
        aspect="video"
        className="mb-12"
      />
      ...
      <DocsBody className="mb-8">
        <h2 id="overview">What is Dimatic?</h2>
        <p className="text-lg mb-6">
          Dimatic is a private platform where you can build AI agents that handle real work. Think of it as the infrastructure and tools you need to create agents that can browse the web, manage files, analyse data, and automate workflows.
        </p>

        <h3 id="meet-dimatic">Dimatic - Your Digital Assistant</h3>
        <p className="mb-4">
          Dimatic is our advanced agent that demonstrates what's possible with the Dimatic platform. It's a generalist AI worker that can:
        </p>
        ...
        <p className="mb-6">
          Dimatic is completely private and shows you what you can build with the Dimatic platform.
        </p>

        <h3 id="build-your-own" className="mb-4">Build Your Own Agents</h3>
        <p className="mb-6">
          The real power comes when you create agents for your specific needs. Maybe you need an agent that monitors customer support tickets, or one that processes invoices, or handles your social media posting schedule. With Dimatic, you get the building blocks to create agents that work exactly how you want them to.
        </p>

        <h3 id="how-it-works" className="mb-4">How It Works</h3>
        <p className="mb-4">Dimatic gives you four main pieces:</p>
        ...
        <h3 id="why-private" className="mb-4">Why Private?</h3>
        <p className="mb-6">
